...
Objects A and B traveling the same narrow, straight road have their motions recorded in the velocity–time graph shown in the figure below.
...
Q1. Describe the motion of each object, including acceleration and displacements during the different portions of their motion.
Q2. Do any of these objects "brush" one another? If so, when and where? If not, why not?
